...
export class OutputChannel extends EventEmitter {
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  private _selectNonRegisteredParameter(parameter, options = {}) {
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  private _deselectRegisteredParameter(options = {}) {
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  private _deselectNonRegisteredParameter(options = {}) {
    this.sendControlChange(0x65, 0x7F, options);
    this.sendControlChange(0x64, 0x7F, options);
    return this;
  }
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  private _selectRegisteredParameter(parameter, options = {}) {
