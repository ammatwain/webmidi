...
class Forwarder {
    ...
    constructor(destinations, options) {
         ...
         */
        this.types = [
            ...Object.keys(Enumerations_1.Enumerations.SYSTEM_MESSAGES),
            ...Object.keys(Enumerations_1.Enumerations.CHANNEL_MESSAGES)
        ];
        /**
        ...
        if (WebMidi_1.WebMidi.validation) {
            ...
            destinations.forEach(destination => {
                if (!(destination instanceof Output_1.Output)) {
    ...
    forward(message) {
        ...
        this.destinations.forEach(destination => {
            if (WebMidi_1.WebMidi.validation && !(destination instanceof Output_1.Output))
                return;
