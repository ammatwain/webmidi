...
class Note {
    ...
    constructor(value, options) {
        ...
        this.duration = WebMidi_1.WebMidi.defaults.note.duration;
        this.attack = WebMidi_1.WebMidi.defaults.note.attack;
        this.release = WebMidi_1.WebMidi.defaults.note.release;
        ...
        if (options.rawAttack != undefined)
            this.attack = Utilities_1.Utilities.from7bitToFloat(options.rawAttack);
        if (options.release != undefined)
            this.release = options.release;
        if (options.rawRelease != undefined) {
            this.release = Utilities_1.Utilities.from7bitToFloat(options.rawRelease);
        }
        // Assign note depending on the way it was specified (name or number)
        if (Number.isInteger(value)) {
            this.identifier = Utilities_1.Utilities.toNoteIdentifier(value);
        }
        else {
    ...
    set identifier(value) {
        const fragments = Utilities_1.Utilities.getNoteDetails(value);
     ...
     */
    get number() {
        return Utilities_1.Utilities.toNoteNumber(this.identifier);
    }
    /**
     ...
     */
    get rawAttack() {
        return Utilities_1.Utilities.fromFloatTo7Bit(this._attack);
    }
    set rawAttack(value) {
        this._attack = Utilities_1.Utilities.from7bitToFloat(value);
    }
    /**
     ...
     */
    get rawRelease() {
        return Utilities_1.Utilities.fromFloatTo7Bit(this._release);
    }
    set rawRelease(value) {
        this._release = Utilities_1.Utilities.from7bitToFloat(value);
    }
    /**
