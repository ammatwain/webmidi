 ...
 * @license Apache-2.0
 */
class Input extends EventEmitter_1.EventEmitter {
    /**
    ...
    constructor(midiInput) {
        ...
        Enumerations_1.Enumerations.CHANNEL_NUMBERS.forEach((i) => {
            this.channels[i] = new InputChannel_1.InputChannel(this, i);
        });
        // Setup listeners
    ...
    _onMidiMessage(e) {
        ...
        const message = new Message_1.Message(e.data);
        /**
    ...
    addForwarder(output, options) {
        ...
        if (output instanceof Forwarder_1.Forwarder) {
            forwarder = output;
        }
        else {
            forwarder = new Forwarder_1.Forwarder(output, options);
        }
