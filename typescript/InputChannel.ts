...
export class InputChannel extends EventEmitter {
  ...
  private _dispatchParameterNumberEvent(type, paramMsb, paramLsb, e) {
  ...
  private _isRpnOrNrpnController(controller) {
  ...
  private _parseEventForParameterNumber(event) {
  ...
  private _parseEventForStandardMessages(e) {
